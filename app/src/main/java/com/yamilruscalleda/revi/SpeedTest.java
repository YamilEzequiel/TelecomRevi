...
import com.yamilruscalleda.revi.utils.GetSpeedTestHostsHandler;
import com.yamilruscalleda.revi.utils.HttpDownloadTest;
import com.yamilruscalleda.revi.utils.HttpUploadTest;
import com.yamilruscalleda.revi.utils.PingTest;
...
public class SpeedTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startButton.setText("Testear Velocidad");
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                startButton.setText("Buscando un servidor aguanta...");
                            }
                        });
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                startButton.setEnabled(true);
                                startButton.setTextSize(16);
                                startButton.setText("Reiniciar  Test");
                            }
                        });
